...
function checkStringa(){
    ...
    for(let i=0; i<movies.length; i++){
        if(movies[i].Title.indexOf(inputTrim) < movies[i].Title.length){
            document.getElementById('filmScelto18').innerHTML += `Il film che hai cercato è: ${movies[i].Title}, anno: ${movies[i].Year}<br><img src="${element.Poster}" alt="Immagine Film">`;
        }
        else{
            document.getElementById('filmScelto18').innerHTML = 'Nessun film contiene questa keyword.'; 
        }
    }
}
